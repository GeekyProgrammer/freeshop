...
else
{
  ...
  $sql = mysqli_query($conn, "SELECT * FROM OFFERS WHERE offer_type = 'Mobile Recharge Offer' ");
...
<body class="home page page-id-471 page-template page-template-tpl-visual_composer page-template-tpl-visual_composer-php customize-support wpb-js-composer js-comp-ver-4.8.1 vc_responsive">
 ...
 <nav>
            ...
            <div class="container"> 
                ...
                <li id="menu-item-565" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-565" style=""><a title="Home" href="index.php">Home</a></li>
                <li id="menu-item-563" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-563" style=""><a title="Freebies" href="freebies.php">Freebies</a></li>
                <li id="menu-item-566" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-566" style=""><a title="Mobile Recharge Offer" href="mobile.php">Mobile Recharge Offer</a></li>
                <li id="menu-item-562" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-562" style=""><a title="Electronics Offer" href="electronics.php">Electronics Offer</a></li>
                <li id="menu-item-567" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-567" style=""><a title="Restaurant Offer" href="restaurant.php">Restaurant Offer</a></li>
                <li id="menu-item-569" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-569" style=""><a title="Travels Offer" href="travel.php">Travels Offer</a></li>
                <li id="menu-item-564" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-564" style=""><a title="Groceries Offer" href="groceries.php">Groceries Offer</a></li>
                        </ul>
