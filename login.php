...
<section class="sub-banner" style="background-image:url(http://demos.megawpthemes.com/comre/files/2015/05/sub-bnr-bg8.jpg);">
  <div class="overlay">
    <div class="container">
    <h2>SIGN UP</h2>
    <ul class="sub-nav"><li><a href="http://freeshopping.co"><i class="fa fa-home"></i></a>  /  </li><li>SIGN IN</li></ul>  
    </div>
  </div>
</section>
            ...
            <ul class="row">
              ...
              <li class="col-md-6">
                <div class="form-group">
                  <label for="lname">User Name *                    <input type="text" name="user_login" class="form-control" id="user_name" placeholder="">
                  </label>
                </div>
              </li>
              <li class="col-md-6">
                <div class="form-group">
                  <label for="password">Password  *                  <input type="password" name="user_password" class="form-control" id="password" placeholder="">
                  </label>
                </div>
              </li>
              <li class="col-md-6">
