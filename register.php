...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
  ...
  {
    $fullname_err = "Name Cannot Be Empty";
  }
  else {
  ...
  if(empty($fullname_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($email_err))
  {
 ...
 <section class="sign-up">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6">
                    <hr>
                    <form action="" name="loginform" method="post" class="form form-register">
            <ul class="row">

              
              <li class="col-md-6">
                <div class="form-group">
                  <label for="fname">Full Name *                    <input type="text" name="fullname" class="form-control" id="full_name" placeholder="">
                  </label>
                </div>
              </li>
              <li class="col-md-6">
              ...
              <li class="col-md-6">
                <div class="form-group">
                  <label for="email">E-mail Address *                    <input type="email" name="email" class="form-control" id="email" placeholder="">
                  </label>
                </div>
              </li>
              <li class="col-md-6">
                <div class="form-group">
                  <label for="password">Password                    <input type="password" name="password" class="form-control" id="password" placeholder="">
                  </label>
                </div>
              </li>
              <li class="col-md-6">
                <div class="form-group">
                  <label for="password4">Confirm Password                    <input type="password" name="confirm_password" class="form-control" id="password4" placeholder="">
                  </label>
                </div>
              </li>
              <li class="col-md-6">
